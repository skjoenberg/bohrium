...
#ifndef __BH_JITK_KERNEL_DEPENDENCIES_RANDOM123_FORTRAN_H
#define __BH_JITK_KERNEL_DEPENDENCIES_RANDOM123_FORTRAN_H

#include <Random123/philox.h>

philox2x32_ctr_t philox2x32_R(unsigned int R, philox2x32_ctr_t ctr, philox2x32_key_t key);

uint64_t random123_wrap(uint64_t start, uint64_t key, uint64_t index) {
