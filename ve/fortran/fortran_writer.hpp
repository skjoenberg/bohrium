#ifndef __BH_FORTRAN_WRITER_HPP
#define __BH_FORTRAN_WRITER_HPP
...
public:
    ...
    void declareIdx(const bh_view &view, const std::string &type_str, int spacing, Scope* scope) {
        declarations << write_spaces(4);
...
*/
    ...
    void write_header(const SymbolTable &symbols, Scope &scope, const LoopB &block, const ConfigParser &config);
};
