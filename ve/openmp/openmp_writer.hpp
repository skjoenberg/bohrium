...
#ifndef BOHRIUM_OPENMP_WRITER_HPP
#define BOHRIUM_OPENMP_WRITER_HPP

#include <string>
#include <sstream>
#include <jitk/writer.hpp>
#include "openmp_instruction.hpp"

using namespace std;
using namespace bohrium;
using namespace jitk;

class OpenMPWriter : public Writer {
public:
    std::stringstream ss;
...
#endif //BOHRIUM_OPENMP_WRITER_HPP
